...
class BlackWhiteSurfaceView(context: Context, attributeSet: AttributeSet) :
    ...
    init {
        ...
        setRenderer(CameraRenderer(context))
    ...
    private fun initPermission() {
        ...
        PermissionUtil.requestPermission(context as Activity, Manifest.permission.CAMERA, 0)
    }
...
//        )
    ...
    companion object {
        private const val TAG = "BlackWhiteSurfaceView"
    }
}