...
//            System.loadLibrary("avdevice-56")
    ...
    external fun mixVideoAndMusic(input_music: String, input_video: String, out_path: String): Int
    // external fun mixVideoAndMusicWithPlay(input_music: String, input_video: String, out_path: String, surface: Surface): Int
}
